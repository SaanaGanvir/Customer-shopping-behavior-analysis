...
-- Which are the top 5 products wity the highest average review rating?
...
--do subscribed customers spend more? compare average spent total and total revenue between subscribers and non-subscribers.
...
--which 5 products have the higgest % of purchase with discounts applied
